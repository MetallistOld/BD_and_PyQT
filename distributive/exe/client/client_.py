...
sys.path.insert(0,'G:\\temp\\GeekBrains\\BD_and_PyQT\\git\\distributive\\exe\\client')
sys.path.insert(0,'G:\\temp\\GeekBrains\\BD_and_PyQT\\git\\distributive\\exe\\client\\')
sys.path.insert(0,'logs')
sys.path.insert(0,'G:\\temp\\GeekBrains\\BD_and_PyQT\\git\\distributive\\exe\\client\\logs')
sys.path.insert(0,'G:\\temp\\GeekBrains\\BD_and_PyQT\\git\\distributive\\exe\\client\\logs\\config_client_log')
sys.path.insert(0,'G:\\temp\\GeekBrains\\BD_and_PyQT\\git\\distributive\\exe\\client\\common')
sys.path.insert(0,'G:\\temp\\GeekBrains\\BD_and_PyQT\\git\\distributive\\exe\\client\\client')
