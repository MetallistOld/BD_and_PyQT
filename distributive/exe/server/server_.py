...
sys.path.insert(0,'G:\\temp\\GeekBrains\\BD_and_PyQT\\git\\distributive\\exe\\server')
sys.path.insert(0,'G:\\temp\\GeekBrains\\BD_and_PyQT\\git\\distributive\\exe\\server\\common')
